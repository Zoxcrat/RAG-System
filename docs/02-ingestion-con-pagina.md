...
- ✅ **Corrida real hecha (2026-06-16):** 2605 chunks del catálogo ingeridos con su
  `page_number`. Acá saltaron 2 bugs que los tests mockeados no veían (batching de
  embeddings y conteo de `execute_values`) — ver [[08-validacion-end-to-end]].
